...
public class DeleteCommandExecutor implements CommandExecutor, TabCompleter {
    ...
    public DeleteCommandExecutor(MacroSetManager macroSetManager) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        macroSetManager.getMacroSet(player).removeMacro(macro.getName());

        player.sendMessage(String.format("Macro \"%s\" deleted.", macro.getName()));
        return true;
    }
