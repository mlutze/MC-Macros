...
public class RemoveCommandExecutorTest {
    ...
    private RemoveCommandExecutor sut;

    @Before
    public void setup() {
        sut = new RemoveCommandExecutor(macroSetManager);
    ...
    public void successfulRemoveTest() {
        ...
        verify(macro).removeLine(0);
        verify(player).sendMessage("Line 0 removed from macro \"macroName\".");
    }
